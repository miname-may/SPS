			...
			<table border="1" class="table table-hover">
		 		<tr>
		 			...
		 			<td> 
			 			...
			 			<select name="YEAR" id="YEAR" title="년도" onblur="resetDateSearch()">
			 				<c:if test="${!empty year}">
			 					<option value="${year}" selected="selected">${year}년</option>
			 				</c:if>
			 			</select>
			 			
		            	<select name="MONTH" id="MONTH" title="월" onblur="resetDateSearch()">
				...
				<th>기간검색</th>
					<td>
						<input id="sDate" type="date" name="startDate" value="${sDate}" onblur="resetRange()"> 
						&nbsp;&nbsp;&nbsp;&nbsp; ~ &nbsp;&nbsp;&nbsp;&nbsp;
						<input id="eDate" type="date" name="endDate" value="${eDate}" onblur="resetRange()">
					</td>
				</tr>
				<tr>
					<th>회원검색</th>
